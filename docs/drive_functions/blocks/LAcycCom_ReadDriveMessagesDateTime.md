# LAcycCom_ReadDriveMessagesDateTime
...
> NOTE
>
> To get the correct time, the clock of the SINAMICS drive unit must be synchronized with the clock of the SIMATIC controller, see [LAcycCom_RTCSinamicsAcyclic](LAcycCom_RTCSinamicsAcyclic.md).
>
> This function block allows to read messages from S120, S210, G120 CU230P-2 and V90 PN. For other G120 CUs, use [LAcycCom_ReadDriveMessagesOperatingHours](LAcycCom_ReadDriveMessagesOperatingHours.md).
...
| messages | ARRAY[0..MESSAGES_COUNT_UPPER_LIM[^note]] OF [LAcycCom_typeDriveMessage](../types/LAcycCom_typeDriveMessage.md#structure) | List of drive messages |
